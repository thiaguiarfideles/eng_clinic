...
from sqlalchemy import func, text, Table, Column, Integer, ForeignKey
...
def editar_acessorio(id):
    ...
    setores = Setor.query.all()
    clientes = Cliente.query.all()
    localizacao = None  # Defina localizacao aqui para evitar o UnboundLocalError
    ...
    return render_template('editar_acessorio.html', acessorio=acessorio, materiais=materiais, fabricantes=fabricantes, setores=setores, clientes=clientes, localizacao=localizacao)
